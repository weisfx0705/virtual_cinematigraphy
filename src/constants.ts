...
export const MAPPING = {
  AZIMUTH: [
    { range: [355, 360], label: '正面 (Front)' as const },
    { range: [0, 5], label: '正面 (Front)' as const },
    { range: [5, 85], label: '左前側 (Front-Left)' as const },
    { range: [85, 95], label: '正左側 (Left Profile)' as const },
    { range: [95, 175], label: '左後側 (Back-Left)' as const },
    { range: [175, 185], label: '背面 (Back)' as const },
    { range: [185, 265], label: '右後側 (Back-Right)' as const },
    { range: [265, 275], label: '正右側 (Right Profile)' as const },
    { range: [275, 355], label: '右前側 (Front-Right)' as const },
  ],
  ELEVATION: [
    { threshold: 60, label: '鳥瞰 (Top Shot)' as const },
    { threshold: 1, label: '俯角 (High Angle)' as const },
    { threshold: 0, label: '平視 (Eye Level)' as const },
    { threshold: -59, label: '仰角 (Low Angle)' as const },
    { threshold: -Infinity, label: '蟲視 (Worm\'s Eye)' as const },
  ],
  DISTANCE: [
